...
class MainActivity : AppCompatActivity() {
    ...
    private fun setCompanyName() {
        val brandItems =  listOf("Volkswagen","Jaguar","Volvo","Lexus","Land Rover","Porsche")
        val adapter = ArrayAdapter(this, R.layout.list_item,brandItems )
        binding.txtCompanyName.setAdapter(adapter)
        //"Maruti","Hyundai","Honda","Tata","Mahindra","Renault","Toyota","MG","Kia","Audi","BMW","Mercedes-Benz","Skoda","Volkswagen","Jaguar","Volvo","Lexus","Land Rover","Porsche"
    }
